...
//Engine Package
package com.example.rukilopes.projetofinal.AndGraph;
...
public class AGSprite 
{
	...
	public static final int NONE = 0, HORIZONTAL = 1, VERTICAL = 2, VERTICAL_HORIZONTAL = 3; //recomendo estudar isso
	
	//Public attributes
	public AGVector2D vrDirection = null;
	public AGVector2D vrPosition = null; //aqui oh... isso são aqueles 2 atributos
	...
	******************************************/
	...
	public boolean collideFrente(AGSprite sprite2)
	{
		float posCima1,posBaixo2;

		posCima1= vrPosition.fY + (iFrameHeight * vrScale.fY);
		posBaixo2 = sprite2.vrPosition.fY - (sprite2.iFrameHeight * sprite2.vrScale.fY);


		if(posCima1 > posBaixo2)//se cima colidir
			return true;
	...
	public boolean collideTras(AGSprite sprite2)
	{
		float posBaixo1,posCima2;

		posBaixo1 = vrPosition.fY - (iFrameHeight * vrScale.fY);

		posCima2= sprite2.vrPosition.fY + (sprite2.iFrameHeight * sprite2.vrScale.fY);

		if(posBaixo1 < posCima2)//se o baixo colidir
			return true;

		return false;
	}

	public boolean collideDireita(AGSprite sprite2)
	{
		float posDireita1,posEsquerda2;

		posDireita1 = vrPosition.fX + (iFrameWidth * vrScale.fX);
		posEsquerda2 = sprite2.vrPosition.fX - (sprite2.iFrameWidth * sprite2.vrScale.fX);

		if(posDireita1 > posEsquerda2)//se a direita colidir
			return true;
	...
	public boolean collideEsquerda(AGSprite sprite2)
	{
		float posEsquerda1,posDireita2;

				posEsquerda1 = vrPosition.fX - (iFrameWidth * vrScale.fX);
				posDireita2 = sprite2.vrPosition.fX + (sprite2.iFrameWidth * sprite2.vrScale.fX);

				if (posEsquerda1 < posDireita2)//se o esquerdo colidir
					return true;
